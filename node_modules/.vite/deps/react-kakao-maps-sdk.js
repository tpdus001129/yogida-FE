...
var Map = import_react2.default.forwardRef(function Map2(_ref, ref) {
  ...
  useIsomorphicLayoutEffect(() => {
    if (!map || typeof draggable === "undefined")
      return;
    map.setDraggable(draggable);
  }, [map, draggable]);
  useIsomorphicLayoutEffect(() => {
    if (!map || typeof zoomable === "undefined")
      return;
...
var MarkerClusterer = import_react5.default.forwardRef(function MarkerClusterer2(_ref, ref) {
  ...
  (0, import_react5.useLayoutEffect)(() => {
    markerClusterer == null ? void 0 : markerClusterer.setMap(map);
  }, [map, markerClusterer]);
  (0, import_react5.useLayoutEffect)(() => {
...
var MarkerClustererRedraw = (_ref2) => {
...
var Marker = import_react6.default.forwardRef(function Marker2(_ref, ref) {
  ...
  (0, import_react6.useLayoutEffect)(() => {
    if (!map || !marker || !markerImage)
      return;
    marker.setImage(markerImage);
  }, [map, marker, markerImage]);
  (0, import_react6.useLayoutEffect)(() => {
    if (!map || !marker || !altitude)
      return;
    marker.setAltitude(altitude);
  }, [map, marker, altitude]);
  (0, import_react6.useLayoutEffect)(() => {
    if (!map || !marker || typeof clickable === "undefined")
      return;
    marker.setClickable(clickable);
  }, [map, marker, clickable]);
  (0, import_react6.useLayoutEffect)(() => {
    if (!map || !marker || typeof draggable === "undefined")
      return;
    marker.setDraggable(draggable);
  }, [map, marker, draggable]);
  (0, import_react6.useLayoutEffect)(() => {
    if (!map || !marker || !opacity)
      return;
