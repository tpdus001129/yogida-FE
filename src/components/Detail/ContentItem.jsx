            ...
            <div className='flex mx-[24px] justify-between' key={index}>
              ...
              <div className='flex flex-col items-center relative'>
                {index === 0 && schedulesData.length > 1 && (
                  <p className='text-[12px] absolute w-[24px] text-center ml-[50px] leading-[24px]'>
                    출발
                  </p>
                )}
                <div className='w-[24px] h-[24px] rounded-full bg-secondary'>
                  {index === schedulesData.length - 1 &&
                    schedulesData.length > 1 && (
                      <p className='text-[12px] absolute w-[24px] text-center ml-[26px] leading-[24px]'>
                        도착
                      </p>
                    )}
                </div>
                <div className='absolute text-[12px] leading-[24px]'>
                  {+index + 1}
                </div>
                {index === schedulesData.length - 1 ? (
                  <div></div>
              ...
              <div className='w-[236px] h-[130px] bg-white rounded-[20px] drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] relative'>
                <div className='h-[43px] flex justify-between items-center ml-[18px] rounded-t-[20px]'>
                  <div className='flex'>
                    <p className='text-[14px] mr-[4px] font-bold'>
                      {places.placeName}
                    </p>
                    <p className='text-[12px] mt-[2px] line-height-[14px]'>
                      {places.category}
                    </p>
                  </div>
