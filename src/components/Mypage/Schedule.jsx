    ...
    <>
      ...
      {addTravelDestination && (
        <div className="relative flex justify-center">
          <div
            className="fixed top-0 left-0 w-screen h-screen bg-gray-1 opacity-50 !m-0 !p-0 z-10"
      ...
      <div className={`${addTravelDestination && 'fixed w-full h-auto overflow-hidden'}`}>
