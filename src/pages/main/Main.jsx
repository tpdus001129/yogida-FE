...
export default function Main() {
  ...
  useEffect(() => {
    postsAPI
      .getAllPosts({ tag: tagValue, sort: sortValue, city: cityValue })
      .then((Posts) => {
                    ...
                    >
                      ...
                      {cityValue ? (
                        ...
                        <span>
                          ...
                          <div className='text-[10px] text-gray-1 text-left'>
                            여행지를 알려주세요.
                          </div>
                        </span>
                      )}
                  ...
                  <button
                    ...
                    onClick={() =>
                      navigate(PATH.filter, {
                        state: { cityValue, tagValue, sortValue },
                      })
                    }
                  >
                    <IoOptionsOutline
                      className={`text-[20px] ${
                        tagValue || sortValue ? 'text-white' : 'text-black'
                      }`}
                    />
                  </button>
                </div>
